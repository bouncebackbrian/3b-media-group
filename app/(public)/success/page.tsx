  ...
  return (
    <div className="bg-[#0a0a0a] text-white min-h-screen flex items-center justify-center px-6">
      <div className="max-w-lg w-full text-center">
        <div className="w-16 h-16 bg-[#F97316]/15 border border-[#F97316]/30 rounded-full flex items-center justify-center mx-auto mb-6">
          <svg className="w-8 h-8 text-[#F97316]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
          </svg>
        </div>

        <p className="text-xs font-bold tracking-[0.2em] uppercase text-[#F97316] mb-4">Payment Confirmed</p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/start-project"
            className="bg-[#F97316] hover:bg-[#ea6c0a] text-white font-bold px-6 py-3 rounded-xl text-sm transition-colors"
          >
            Complete Intake Now →
          </Link>
          <Link

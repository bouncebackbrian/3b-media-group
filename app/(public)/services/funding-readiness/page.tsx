    ...
    <div className="bg-[#0a0a0a] text-white min-h-screen">
      <section className="px-6 py-20 border-b border-white/8">
        <div className="max-w-3xl mx-auto">
          <p className="text-xs font-bold tracking-[0.2em] uppercase text-[#F97316] mb-4">Funding-Readiness Web Package</p>
          ...
          <p className="text-white/40 leading-relaxed text-sm mb-8 border-l-2 border-[#F97316]/40 pl-4">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/checkout/funding-readiness-web" className="bg-[#F97316] hover:bg-[#ea6c0a] text-white font-bold px-6 py-3 rounded-xl text-sm transition-colors">
              Get Started — $3,500
            </Link>
          ...
          <div className="space-y-5">
            <div className="bg-[#111] border border-white/8 rounded-2xl p-6">
              ...
              <div className="flex items-baseline gap-2 mb-1">
                <span className="text-3xl font-black text-[#F97316]">$3,500</span>
              </div>
              <p className="text-white/35 text-xs">Fixed price. Defined scope.</p>
            </div>

            <div className="bg-[#F97316]/8 border border-[#F97316]/20 rounded-2xl p-6">
              <h3 className="font-bold text-[#F97316] mb-3 text-sm uppercase tracking-wider">Important Disclaimer</h3>
              ...
              <Link href="/disclaimer" className="text-[#F97316] text-xs hover:underline mt-3 block">Read full disclaimer →</Link>
            </div>

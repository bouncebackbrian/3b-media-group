    ...
    <div className="bg-[#0a0a0a] text-white min-h-screen">
      <section className="px-6 py-20 border-b border-white/8">
        <div className="max-w-3xl mx-auto">
          <p className="text-xs font-bold tracking-[0.2em] uppercase text-[#F97316] mb-4">Domain Setup</p>
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/checkout/domain-starter" className="bg-[#F97316] hover:bg-[#ea6c0a] text-white font-bold px-6 py-3 rounded-xl text-sm transition-colors">
              Get Started — $199
            </Link>
      ...
      <section className="px-6 py-20 border-b border-white/8">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="bg-[#111] border border-white/8 rounded-2xl p-6 space-y-3">
            ...
            <div className="mt-8 bg-[#111] border border-white/8 rounded-2xl p-6">
              ...
              <div className="flex items-baseline gap-2 mb-2">
                <span className="text-3xl font-black text-[#F97316]">$199</span>
      ...
      <section className="px-6 py-16 text-center border-b border-white/8">
        ...
        <Link href="/packages" className="text-[#F97316] hover:underline text-sm font-semibold">See all packages →</Link>
      </section>
    </div>
  )
}

    ...
    <div className="bg-[#0a0a0a] text-white min-h-screen">
      <section className="px-6 py-20 border-b border-white/8">
        <div className="max-w-3xl mx-auto">
          <p className="text-xs font-bold tracking-[0.2em] uppercase text-[#F97316] mb-4">Logo Design</p>
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/checkout/brand-starter" className="bg-[#F97316] hover:bg-[#ea6c0a] text-white font-bold px-6 py-3 rounded-xl text-sm transition-colors">
              Get Started — $499
            </Link>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-[#111] border border-white/8 rounded-2xl p-6">
              ...
              <div className="flex items-baseline gap-2 mb-1">
                <span className="text-3xl font-black text-[#F97316]">$499</span>
              </div>

    ...
    <div className="bg-[#0A1A2F] text-white min-h-screen">
      <section className="px-6 py-20 border-b border-white/8">
        <div className="max-w-3xl mx-auto">
          <p className="text-xs font-bold tracking-[0.2em] uppercase text-[#14B8A6] mb-4">Credibility Builder</p>
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/checkout/credibility-builder" className="bg-[#14B8A6] hover:bg-[#0D9488] text-white font-bold px-6 py-3 rounded-xl text-sm transition-colors">
              Get Started — $2,500
            </Link>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {[
              ...
              <div key={section.cat} className="bg-[#11243D] border border-white/8 rounded-2xl p-6">
                <p className="text-xs font-bold tracking-widest uppercase text-[#14B8A6] mb-4">{section.cat}</p>
          ...
          <div className="mt-8 bg-[#11243D] border border-white/8 rounded-2xl p-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="text-right shrink-0">
                <div className="text-3xl font-black text-[#14B8A6]">$2,500</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="px-6 py-16 text-center border-b border-white/8">
        ...
        <Link href="/services/funding-readiness" className="text-[#14B8A6] hover:underline text-sm font-semibold">See Funding-Readiness Package →</Link>
      </section>
    </div>
  )
}

...
export default function GrowPage() {
  return (
    <div className="bg-[#0A1A2F] text-white">
      <section className="px-4 sm:px-6 py-16 sm:py-20 border-b border-white/8">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-xs font-bold tracking-[0.2em] uppercase text-[#14B8A6] mb-4">Business Growth Wizard</p>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black mb-5 tracking-tight">
      ...
      <section className="px-4 sm:px-6 py-5 border-b border-white/8 bg-[#081320]">
        <div className="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-4">
          {benefits.map((b) => (
            <div key={b.title} className="flex items-start gap-3 py-1">
              <span className="text-[#14B8A6] text-xl font-mono shrink-0">{b.icon}</span>
              <div>

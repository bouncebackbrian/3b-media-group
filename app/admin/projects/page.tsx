                  ...
                  return (
                    <tr key={p.id} className="hover:bg-white/3 transition-colors">
                      <td className="px-5 py-3.5">
                        <Link href={`/admin/projects/${p.id}`} className="font-semibold text-sm hover:text-[#14B8A6] transition-colors">{c?.full_name ?? '—'}</Link>
                      ...
                      <td className="px-5 py-3.5 text-white/35 text-xs hidden md:table-cell">
                        {p.live_url ? <a href={p.live_url} target="_blank" className="text-[#14B8A6] hover:underline">{p.live_url}</a> : '—'}
                      </td>
